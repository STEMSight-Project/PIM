...
echo "🎯 Next Steps:"
echo ""
echo "1️⃣  Configure your Raspberry Pi:"
echo "   cd $PROJECT_DIR"
echo "   ./configure.py"
echo ""
echo "2️⃣  Test the broadcaster manually:"
echo "   ./start.sh"
echo ""
echo "3️⃣  Enable auto-start on boot:"
echo "   sudo systemctl enable stemsight-broadcaster"
echo ""
echo "4️⃣  Start the service:"
echo "   sudo systemctl start stemsight-broadcaster"
echo ""
echo "5️⃣  Check status and logs:"
echo "   ./status.sh"
echo "   OR"
echo "   sudo journalctl -u stemsight-broadcaster -f"
echo ""
echo "📚 Quick Commands:"
echo "   Start:   sudo systemctl start stemsight-broadcaster"
echo "   Stop:    sudo systemctl stop stemsight-broadcaster"
echo "   Restart: sudo systemctl restart stemsight-broadcaster"
echo "   Status:  ./status.sh"
echo "   Logs:    sudo journalctl -u stemsight-broadcaster -f"
echo ""
