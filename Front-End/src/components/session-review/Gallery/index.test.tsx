...
describe('SessionGallery Component', () => {
  ...
  describe('Rendering', () => {
    ...
    test('shows empty state when no sessions', () => {
      ...
      expect(screen.getByText('No sessions found matching your search.')).toBeInTheDocument();
    });
  });
  ...
  describe('Sorting', () => {
    ...
    test('sorts by oldest first when selected', () => {
      ...
      const firstSession = sessionNames.find(el => el.textContent?.includes('Bob Johnson'));
  ...
  describe('Session Selection', () => {
    test('highlights selected session', () => {
      ...
      const selectedSession = screen.getByText('John Doe').closest('.bg-blue-50');
      expect(selectedSession).toHaveClass('bg-blue-50', 'border-l-4', 'border-blue-500');
    });
  ...
  describe('Grid View', () => {
    ...
    test('highlights selected session in grid view', () => {
      ...
      expect(selectedSession).toHaveClass('bg-blue-50', 'border-2', 'border-blue-500');
    });
  });
