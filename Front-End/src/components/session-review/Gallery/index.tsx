              ...
              >
                  ...
                  <div>
                    <h3
                      className={`text-sm font-medium ${
                        session.isSelected ? "text-blue-800" : "text-gray-800"
                      }`}
                    >
                    ...
                    <p
                      className={`text-xs ${
                        session.isSelected ? "text-blue-600" : "text-gray-600"
                      }`}
                    >
                ...
                <div className="mt-1 flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    >
                      {session.detectionCount > 0
                        ? `${session.detectionCount} detection${
            ...
            {sessions.map((session) => (
              ...
              >
                ...
                >
                  ...
                  {session.date.split(" ")[1].slice(0, -1)}, {session.time}
                </p>
                <div className="flex justify-between items-center mt-1">
                  ...
                  <span className="text-xs text-green-700">
                    ...
                    {session.detectionCount === 1 ? "detection" : "detections"}
                  </span>
                </div>
              </div>
            ))}
