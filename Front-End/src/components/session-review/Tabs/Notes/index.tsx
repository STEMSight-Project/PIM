...
const Notes: React.FC<NotesProps> = ({ sessionId, setCurrentTimestamp, currentVideoTime }) => {
  ...
  const handleAddNote = () => {
    ...
    const newNoteObj: Note = {
      id: `note-${Date.now()}`,
      content: newNote,
      created_time: now.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
