...
import { hlsService, HLSRecordingStatus } from '@/services/hlsService';
...
describe('hlsService', () => {
  ...
  describe('getRecordingStatus', () => {
    it('should fetch recording status successfully', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/videos/hls/AMB-001-ROOM-001/status');
    });
  ...
  describe('deleteRecording', () => {
    it('should delete recording successfully', async () => {
      ...
      expect(mockApi.delete).toHaveBeenCalledWith('/videos/hls/AMB-001-ROOM-001');
    });
  ...
  describe('pollRecordingStatus', () => {
    ...
    it('should poll status and call callback on segment change', async () => {
      ...
      const cleanup = hlsService.pollRecordingStatus('AMB-001-ROOM-001', callback, 1000);
